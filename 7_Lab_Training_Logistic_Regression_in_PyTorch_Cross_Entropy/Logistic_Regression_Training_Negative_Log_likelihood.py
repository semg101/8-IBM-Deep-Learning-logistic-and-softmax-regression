...
#Replace the random initialized variable values. 
#Theses random initialized variable values did convergence for the RMS Loss but will converge for the Cross-Entropy Loss.
